...
const BooksPage: React.FC = () => {
  ...
  const handleEdit = (id: number) => {
    router.push(`/books/edit/${id}`); // Fixed template literal
  };

  const handleView = (id: number) => {
    router.push(`/books/view/${id}`); // Fixed template literal
  };

  const handleDelete = (id: number) => {
    router.push(`/books/delete/${id}`); // Fixed template literal
  };

  const handleUpdate = (id: number) => {
    router.push(`/books/update/${id}`); // Fixed template literal
  };
